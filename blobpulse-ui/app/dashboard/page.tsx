...
export default function DashboardPage({ color = "cyan" }: { color?: ColorKey }) {
    ...
    const handleDownload = () => {
        downloadExcelReport(connectionString, containerName);
    };
        ...
        return (
            <div className="relative h-screen bg-slate-950 text-white p-6 flex flex-col gap-6">
                ...
                <div className="opacity-30 pointer-events-none">
                    <Header
                        onScan={() => executeScan(connectionString, containerName, false)}
                        onForceScan={() => executeScan(connectionString, containerName, true)}
